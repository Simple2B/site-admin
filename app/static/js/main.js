...
var switchInputs = function (btnOne, btnTwo, visibleElements, hiddenElements) {
    var isActive = btnOne.getAttribute('active') === 'true';
    if (isActive) {
        return;
    }
    btnOne.setAttribute('active', 'true');
    btnTwo.setAttribute('active', 'false');
    var activeClassNames = btnTwo.className.split(' ');
    var notActiveClassNames = btnOne.className.split(' ');
    btnTwo.className = '';
    btnTwo.className = notActiveClassNames.join(' ');
    btnOne.className = '';
    btnOne.className = activeClassNames.join(' ');
    visibleElements.forEach(function (div) {
        div.style.display = 'none';
        div.lastElementChild.attributes.removeNamedItem('required');
    });
    hiddenElements.forEach(function (div) {
        div.style.display = 'block';
        var inputEl = div.lastElementChild;
        inputEl.setAttribute('required', '');
    });
};
var editCase = function (caseId) { return __awaiter(void 0, void 0, void 0, function () {
    var title, subTitle, description, projectLink, role, isActive, isMain, stacks, mainImage, previewImage, divCaseScreenShoots, caseIdElement, caseIdCopyElement, mainImageInput, subMainImageInput, elements, response, error_1, caseData, listOfScreenshots;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                caseIdCopyElement = document.querySelector('#caseIdEditCopy');
...
var cases = function () {
    var selectLanguage = document.querySelector('#language');
    if (selectLanguage) {
    ...
    editCaseButton.forEach(function (e) {
        e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var caseId, divCaseScreenShoots;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // }
                        editCaseModal.show();
                        caseId = Number(e.getAttribute('data-edit-id'));
                        return [4 /*yield*/, editCase(caseId)];
                    case 1:
                        _a.sent();
                        divCaseScreenShoots = document.querySelector('#edit-case-screenshots');
                        editCaseModal._options.onHide = function () {
...
var useConfirmModal = function () {
    ...
    var openModal = function (textModal, confirmCallBack) {
        ...
        if (caseConfirmModalText &&
            ...
            confirmCaseModal._options.onHide = function () {
