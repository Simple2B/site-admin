...
var admin = function () {
    ...
    var openModal = (0, utils_1.useConfirmModal)().openModal;
    var addModal = new flowbite_1.Modal($addAdminModalElement, modalOptions);
    // opening add user modal
    var addAdminButton = document.querySelector('#add-admin-btn');
    if (addAdminButton) {
    ...
    // delete admin
    var deleteAdminButtons = document.querySelectorAll('#delete-admin-btn');
    if (deleteAdminButtons) {
        deleteAdminButtons.forEach(function (button) {
            button.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, modalText, confirmCallback;
                return __generator(this, function (_a) {
                    id = button.getAttribute('data-admin-id');
                    modalText = "Are you sure you want to delete admin \u2116".concat(id, "?");
                    confirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
                        var id, response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
...
var candidate = function () {
    // search flow
    var searchInput = document.querySelector('#table-search-candidates');
    var searchInputButton = document.querySelector('#table-search-candidates-button');
    var openModal = (0, utils_1.useConfirmModal)().openModal;
    ...
    // delete candidate
    var deleteButtons = document.querySelectorAll('#delete-candidate-btn');
    deleteButtons.forEach(function (button) {
        button.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var id, textModal, confirmCallback;
            return __generator(this, function (_a) {
                id = button.getAttribute('data-candidate-id');
                textModal = "Are you sure you want to delete candidate ".concat(id, "?");
                confirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fetch("/candidate/delete/".concat(id), {
                                    method: 'DELETE',
                                })];
                            case 1:
                                response = _a.sent();
...
var flowbite_1 = __webpack_require__(/*! flowbite */ "./node_modules/flowbite/lib/esm/index.js");
var utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
var createCaseScreenshot = function (screenshot) {
    ...
    deleteBtn.setAttribute('class', 'px-3 py-2 text-xs font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800');
    ...
    deleteBtn.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/case/delete/".concat(screenshot.id, "/screenshot"), {
                        method: 'DELETE',
                    })];
                case 1:
                    response = _a.sent();
...
var editCase = function (caseId) { return __awaiter(void 0, void 0, void 0, function () {
    var title, subTitle, description, projectLink, role, isActive, isMain, stacks, mainImage, previewImage, divCaseScreenShoots, caseIdElement, mainImageInput, subMainImageInput, elements, response, error_1, caseData, listOfScreenshots;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = document.querySelector('#edit-case-title');
                subTitle = document.querySelector('#edit-case-sub-title');
                description = document.querySelector('#edit-case-description');
                projectLink = document.querySelector('#edit-case-project-link');
                role = document.querySelector('#edit-case-role');
                isActive = document.querySelector('#edit-case-is-active');
                isMain = document.querySelector('#edit-case-is-main');
                stacks = document.querySelectorAll('#stacks input[type="checkbox"]');
                mainImage = document.querySelector('#edit-case-main-image');
                previewImage = document.querySelector('#edit-case-preview-image');
                divCaseScreenShoots = document.querySelector('#edit-case-screenshots');
                caseIdElement = document.querySelector('#caseIdEdit');
                mainImageInput = document.querySelector('#edit-case-main-image-input');
                subMainImageInput = document.querySelector('#edit-case-sub-main-image-input');
                elements = [
                    title,
                    subTitle,
                    description,
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, fetch("/case/".concat(caseId), {
                        method: 'GET',
                    })];
            case 2:
                response = _a.sent();
            ...
            case 5:
                caseData = _a.sent();
                listOfScreenshots = caseData.screenshots;
                listOfScreenshots.forEach(function (screenshot) {
                    divCaseScreenShoots.appendChild(createCaseScreenshot(screenshot));
                });
                stacks.forEach(function (checkbox) {
                ...
                mainImageInput.addEventListener('change', function () {
                    var files = mainImageInput.files;
                    if (files.length > 0) {
                        mainImage.src = URL.createObjectURL(files[0]);
                    }
                });
                subMainImageInput.addEventListener('change', function () {
                    var files = subMainImageInput.files;
                    if (files.length > 0) {
...
var cases = function () {
    var $addUserModalElement = document.querySelector('#addCaseModal');
    var $stackModalElement = document.querySelector('#stackModal');
    var scrfInput = document.querySelector('#csrf_token');
    var $caseEditModalElement = document.querySelector('#caseEditModalElement');
    var openModal = (0, utils_1.useConfirmModal)().openModal;
    var addModal = new flowbite_1.Modal($addUserModalElement, utils_1.modalOptions);
    var stackModal = new flowbite_1.Modal($stackModalElement, utils_1.modalOptions);
    var editCaseModal = new flowbite_1.Modal($caseEditModalElement, utils_1.modalOptions);
    // callBack on btn is_active and is_main
    var caseConfirmModalListener = function (event, inputElement) {
        event.preventDefault();
        var caseId = inputElement.getAttribute('data-case-id');
        var caseStatusAtr = inputElement.getAttribute('data-case-status');
        var dataFiled = inputElement.getAttribute('data-field');
        var isCaseActive = caseStatusAtr === 'True';
        var caseConfirmModalText;
        var text = 'Are you sure you want to';
        if (dataFiled === 'is_active') {
            caseConfirmModalText = isCaseActive
                ? "".concat(text, " deactivate case ").concat(caseId)
                : "".concat(text, " activate case ").concat(caseId);
        }
        else if (dataFiled === 'is_main') {
            caseConfirmModalText = isCaseActive
                ? "".concat(text, " deactivate main case ").concat(caseId)
                : "".concat(text, " activate main case ").concat(caseId);
        }
        var confirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("/case/update-status/".concat(caseId), {
                                method: 'PATCH',
                                body: formData,
                            })];
                    case 1:
    ...
    var activateCaseButton = document.querySelectorAll('#activate-case-btn');
    activateCaseButton.forEach(function (btnElement) {
        btnElement.addEventListener('click', function (e) {
            return caseConfirmModalListener(e, btnElement);
        });
    });
    var mainCaseButton = document.querySelectorAll('#main-case-btn');
    mainCaseButton.forEach(function (btnElement) {
        btnElement.addEventListener('click', function (e) {
            return caseConfirmModalListener(e, btnElement);
        });
    });
    var stackButton = document.querySelector('#modal-stack-btn');
    if (stackButton) {
        stackButton.addEventListener('click', function () {
            stackModal.show();
        });
        // closing add stack modal
        var stackModalCloseBtn = document.querySelector('#modalStackCloseButton');
        if (stackModalCloseBtn) {
            stackModalCloseBtn.addEventListener('click', function () {
                stackModal.hide();
            });
        }
    }
    // opening add user modal
    var addCaseButton = document.querySelector('#add-case-btn');
    if (addCaseButton) {
        addCaseButton.addEventListener('click', function () {
            addModal.show();
        });
        // closing add user modal
        var addModalCloseBtn = document.querySelector('#modalAddCaseCloseButton');
        if (addModalCloseBtn) {
            addModalCloseBtn.addEventListener('click', function () {
                addModal.hide();
            });
        ...
        // search flow
        var searchInput_1 = document.querySelector('#table-search-cases');
        var searchInputButton = document.querySelector('#table-search-cases-button');
        if (searchInputButton && searchInput_1) {
            searchInputButton.addEventListener('click', function () {
                var url = new URL(window.location.href);
                url.searchParams.set('q', searchInput_1.value);
                window.location.href = "".concat(url.href);
            });
        }
        var deleteButtons = document.querySelectorAll('#delete-case-btn');
        deleteButtons.forEach(function (e) {
            e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var caseId, modalText, confirmCallback;
                return __generator(this, function (_a) {
                    caseId = e.getAttribute('data-case-id');
                    modalText = "Are you sure you want to delete case ".concat(caseId, "?");
                    confirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, fetch("/case/delete/".concat(caseId), {
                                        method: 'DELETE',
                                    })];
                                case 1:
                                    response = _a.sent();
    ...
    var editCaseButton = document.querySelectorAll('#edit-case-btn');
    editCaseButton.forEach(function (e) {
        e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var caseId, editModalCloseBtn, divCaseScreenShoots;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        editCaseModal.show();
                        caseId = e.getAttribute('data-edit-id');
                        return [4 /*yield*/, editCase(Number(caseId))];
                    case 1:
                        _a.sent();
                        editModalCloseBtn = document.querySelector('#editCaseModalClose');
                        divCaseScreenShoots = document.querySelector('#edit-case-screenshots');
...
function flash() {
    ...
    var $targetEl = document.querySelector('[id^=toast-]');
    // optional trigger element
    var $triggerEl = document.querySelector('#closeToastBtn');
    // options object
    var options = {
        transition: 'transition-opacity',
        duration: 1000,
    ...
    if ($targetEl && $triggerEl && dismiss) {
        var targetType_1 = $targetEl.getAttribute('id');
        $triggerEl.addEventListener('click', function () {
            dismiss.hide();
        });
        setTimeout(function () {
            if (targetType_1.includes('danger')) {
...
var questions = function () {
    var $addQuestionModalElement = document.querySelector('#addQuestionModal');
    var $editQuestionModalElement = document.querySelector('#editQuestionModal');
    var openModal = (0, utils_1.useConfirmModal)().openModal;
    var addQuestionModal = new flowbite_1.Modal($addQuestionModalElement, utils_1.modalOptions);
    var editQuestionModal = new flowbite_1.Modal($editQuestionModalElement, utils_1.modalOptions);
    // opening add user modal
    ...
    if (addQuestionButton) {
        ...
        // closing add user modal
        var addModalCloseBtn = document.querySelector('#modalAddQuestionCloseButton');
        if (addModalCloseBtn) {
            addModalCloseBtn.addEventListener('click', function () {
        ...
        // // search flow
        var searchInput_1 = document.querySelector('#table-search-question');
        var searchInputButton = document.querySelector('#table-search-question-button');
        if (searchInputButton && searchInput_1) {
            searchInputButton.addEventListener('click', function () {
                var url = new URL(window.location.href);
                url.searchParams.set('q', searchInput_1.value);
        ...
        deleteButtons.forEach(function (e) {
            e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var questionId, modalText, confirmCallback;
                return __generator(this, function (_a) {
                    questionId = e.getAttribute('data-question-id');
                    modalText = "Are you sure you want to delete question ".concat(questionId, "?");
                    confirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, fetch("/quiz/delete/".concat(questionId), {
                                        method: 'DELETE',
                                    })];
                                case 1:
                                    response = _a.sent();
    ...
    var editQuestionButton = document.querySelectorAll('#edit-question-btn');
    if (editQuestionButton) {
        editQuestionButton.forEach(function (btn) {
            btn.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, response, data, questionId, questionUuid, questionText, questionVariantOne, questionVariantTwo, questionVariantThree, questionVariantFour, questionCorrectAnswerMark, selectedOption, selectOptions, questionTitle;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            editQuestionModal.show();
                            id = btn.getAttribute('data-question-id');
                            return [4 /*yield*/, fetch("/quiz/get/".concat(id), {
                                    method: 'GET',
                                })];
                        case 1:
                            response = _a.sent();
                        ...
                        case 2:
                            data = _a.sent();
                            questionId = document.querySelector('#id');
                            questionUuid = document.querySelector('#uuid');
                            questionText = document.querySelector('#question-text');
                            questionVariantOne = document.querySelector('#question-variant-one');
                            questionVariantTwo = document.querySelector('#question-variant-two');
                            questionVariantThree = document.querySelector('#question-variant-three');
                            questionVariantFour = document.querySelector('#question-variant-four');
                            questionCorrectAnswerMark = document.querySelector('#correct_answer_mark');
                            selectedOption = document.querySelector("#select_option_".concat(data.correct_answer_mark));
                            selectOptions = document.querySelectorAll('[id^="select_option"]');
                            ...
                            if (data &&
                                ...
                                questionTitle.textContent = "Question: ".concat(data.id);
                                ...
                                selectOptions.forEach(function (opt, index) {
                                    opt.textContent = "".concat(index + 1, ": ").concat(data.variants[index].text);
                                    opt.value = "".concat(index + 1);
                                });
        ...
        // closing add user modal
        var editModalCloseBtn = document.querySelector('#modalEditQuestionCloseButton');
        if (editModalCloseBtn) {
            editModalCloseBtn.addEventListener('click', function () {
...
var utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
var stack = function () {
    var form = document.getElementById('add-stack-form');
    var inputElement = document.getElementById('add-stack-form-input');
    var stacksDiv = document.getElementById('add-stack-form-stacks');
    var scrfInput = document.querySelector('#csrf_token');
    var oldSpansName = [];
    if (stacksDiv) {
        stacksDiv
            .querySelectorAll('span')
            .forEach(function (span) { return oldSpansName.push(span.textContent); });
    }
    var listElementsCases = document.getElementById('listOfCases');
    var $deleteStackModal = document.querySelector('#deleteStackModal');
    var stackModalWarning;
    if ($deleteStackModal) {
        stackModalWarning = new flowbite_1.Modal($deleteStackModal, utils_1.modalOptions);
    }
    var stackModalCloseBtn = document.querySelector('#modalStackCloseButtonError');
    if (stackModalCloseBtn) {
        stackModalCloseBtn.addEventListener('click', function () {
    ...
    var listOfStacks = document.querySelectorAll('[id^="button-"]');
    if (listOfStacks) {
        listOfStacks.forEach(function (button) {
            var stackId = button.id.replace('button-', '');
            button.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch("/stack/delete/".concat(stackId), {
                                method: 'DELETE',
                            })];
                        case 1:
                            response = _a.sent();
    ...
    if (form) {
        form.onkeydown = function (e) {
            if (e.key === 'Enter' && inputElement.value && stacksDiv) {
                e.preventDefault();
                var newStack = document.createElement('span');
                ...
                var newSpansName = Array.from(stacksDiv.querySelectorAll('span')).map(function (span) { return span.textContent; });
                if (!oldSpansName.includes(inputElement.value) &&
    ...
    function handleSubmit(event) {
        return __awaiter(this, void 0, void 0, function () {
            var newStacks, fetchStr, formData, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        event.preventDefault();
                        if (!stacksDiv) return [3 /*break*/, 2];
                        newStacks = Array.from(stacksDiv.querySelectorAll('span'))
                            .map(function (span) { return span.textContent; })
                            .filter(function (stack) { return !oldSpansName.includes(stack); });
                        if (inputElement &&
                            inputElement.value &&
                            !newStacks.includes(inputElement.value)) {
                            newStacks.push(inputElement.value);
                        }
                        fetchStr = newStacks.join(',');
                        if (!fetchStr) return [3 /*break*/, 2];
                        formData = new FormData();
                        formData.append('stacks', fetchStr);
                        formData.append('csrf_token', scrfInput ? scrfInput.value : '');
                        return [4 /*yield*/, fetch("/stack/create", {
                                method: 'POST',
                                body: formData,
                            })];
                    case 1:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.useConfirmModal = exports.modalOptions = void 0;
var flowbite_1 = __webpack_require__(/*! flowbite */ "./node_modules/flowbite/lib/esm/index.js");
...
var useConfirmModal = function () {
    var $confirmCaseModalElement = document.querySelector('#confirm-modal-element');
    var confirmCaseModal = new flowbite_1.Modal($confirmCaseModalElement, exports.modalOptions);
    var openModal = function (textModal, confirmCallBack) {
        confirmCaseModal.show();
        var caseConfirmModalText = document.querySelector('#confirm-modal-text');
        var closeModalBtn = document.querySelector('#close-confirm-modal-btn');
        var agreeConfirmModalBtn = document.querySelector('#agree-confirm-modal-btn');
        var disagreeConfirmModalBtn = document.querySelector('#disagree-confirm-modal-btn');
        if (caseConfirmModalText &&
            agreeConfirmModalBtn &&
            disagreeConfirmModalBtn &&
            closeModalBtn) {
            caseConfirmModalText.innerHTML = textModal;
            var notConfirmCallback = function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
...
var admin_1 = __webpack_require__(/*! ./admin */ "./src/admin.ts");
var case_1 = __webpack_require__(/*! ./case */ "./src/case.ts");
var question_1 = __webpack_require__(/*! ./question */ "./src/question.ts");
var stack_1 = __webpack_require__(/*! ./stack */ "./src/stack.ts");
var candidate_1 = __webpack_require__(/*! ./candidate */ "./src/candidate.ts");
var flash_1 = __webpack_require__(/*! ./flash */ "./src/flash.ts");
(0, flash_1.flash)();
(0, base_1.base)();
(0, admin_1.admin)();
(0, question_1.questions)();
(0, candidate_1.candidate)();
(0, case_1.cases)();
(0, stack_1.stack)();
