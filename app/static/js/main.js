...
var questions = function () {
    ...
    var addQuestionModal = new flowbite_1.Modal($addQuestionModalElement, modalOptions);
    ...
    if (editQuestionButton) {
        editQuestionButton.forEach(function (btn) {
            btn.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, response, data, questionId, questionUuid, questionText, questionVariantOne, questionVariantTwo, questionVariantThree, questionVariantFour, questionCorrectAnswerMark, selectedOption;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
var user = function () {
    ...
    var addModal = new flowbite_1.Modal($addUserModalElement, addModalOptions);
    // opening add user modal
    ...
    if (addUserButton) {
        ...
        // search flow
        var searchInput_1 = document.querySelector('#table-search-users');
