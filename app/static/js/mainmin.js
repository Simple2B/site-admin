...
var cases = function () {
    ...
    var editCaseModal = new flowbite_1.Modal($caseEditModalElement, modalOptions);
    ...
    editCaseButton.forEach(function (e) {
        e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var caseId, response, caseData, listOfStacks, title, subTitle, description, role, isActive, isMain, stacks, caseIdElement, editModalCloseBtn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        editCaseModal.show();
                        ...
                        console.log(caseId);
                        return [4 /*yield*/, fetch("/case/get/".concat(caseId), {
                                method: 'GET',
                            })];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        caseData = _a.sent();
                        console.log(caseData._stacks.map(function (stack) { return stack.name; }));
                        listOfStacks = caseData._stacks.map(function (stack) { return stack.name; });
...
var stack = function () {
    ...
    form.onkeydown = function (e) {
        if (e.keyCode == 13 && name.value && stacksDiv) {
            ...
            if (!oldSpansName.includes(name.value) && !newSpansName.includes(name.value)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newStacks = Array.from(stacksDiv.querySelectorAll('span')).map(function (span) { return span.textContent; }).filter(function (stack) { return !oldSpansName.includes(stack); });
