export const stack = () => {
    ...
    const name = document.getElementById('add-stack-form-input') as HTMLInputElement
    ...
    const oldSpansName = Array.from(stacksDiv.querySelectorAll('span')).map(( span ) => span.textContent)
